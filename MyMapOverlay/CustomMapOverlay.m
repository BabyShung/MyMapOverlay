          ...
          inContext:(CGContextRef)ctx
{
    ...
    //draw line
//    CGFloat centerX = overlayRect.origin.x + radiusAtLatitude;
//    CGFloat centerY = overlayRect.origin.y + radiusAtLatitude;
    CGFloat centerX = [[self overlay] coordinate].longitude;
    CGFloat centerY = [[self overlay] coordinate].latitude;
    ...
    CGContextMoveToPoint(ctx, centerX, centerY); //start at this point
    
    CGContextAddLineToPoint(ctx, centerX + 30, centerY + 550); //draw to this point
